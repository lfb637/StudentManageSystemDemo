...
<form action="${pageContext.request.contextPath }/servlet/doLogin" onsubmit="return validate_form()" method="post">
    <table class="loginTable">
      <tr>
       <td id="name">用户名：</td>
       <td id="nmtd"><input type="text" name="username" id="username" value = "${username}"></td>
      </tr>
       <tr>
       <td id="pwd">密&nbsp;&nbsp;&nbsp;&nbsp;码：</td>
       <td id="pwdtd"><input type="password" name="password" id="password" value = "${password}"></td>
      </tr>
      <tr>
       <td><input type="submit" value="登录"></td>
       <td><button onclick = "resetValue()">重置</button></td>
      </tr>
    </table>
</form>
</body>
